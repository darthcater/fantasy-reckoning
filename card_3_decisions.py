"""
Card 3: The Decisions - Weekly Management
...
def calculate_card_3_decisions(calc, team_key: str) -> dict:
    """
    Calculate Card 3: The Decisions - Weekly lineup management analysis
