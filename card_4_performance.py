"""
Card 4: The Performance - Season Results
...
def calculate_card_4_performance(calc, team_key: str, other_cards: dict = None) -> dict:
    """
    Calculate Card 4: The Performance - Season results analysis
